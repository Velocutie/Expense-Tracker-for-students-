  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <Link href="/money-received" className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl px-4 py-3 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-750 transition-all active:scale-[0.96]"><Plus size={16} /> Add Money</Link>
        <Link href="/saved-money" className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl px-4 py-3 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-750 transition-all active:scale-[0.96]"><Plus size={16} /> Save Money</Link>
        <Link href="/savings-goals" className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl px-4 py-3 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-750 transition-all active:scale-[0.96]"><Plus size={16} /> New Goal</Link>
      </div>
          ...
          {recentExpenses.length > 0 ? (
            <div className="space-y-2">
              {recentExpenses.map(e => {
                ...
                const Icon = cat?.icon;
                return (
                  <div key={e.id} className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-750 transition-all active:scale-[0.99] cursor-default">
